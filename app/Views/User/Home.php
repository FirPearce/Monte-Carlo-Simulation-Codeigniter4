...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#page-top">MediPredict</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#projects">How to Use</a></li>
        ...
        <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                <div class="text-center">
                    <h1 class="mx-auto my-0 text-uppercase">MediPredict</h1>
                    <h2 class="text-white-50 mx-auto mt-2 mb-5">Prediksikan Penjualan Obat mu Sekarang!!</h2>
                    <a class="btn btn-primary" href="<?= base_url('Home/login'); ?>">Mulai Sekarang</a>
                </div>
            </div>
        </div>
    </header>
