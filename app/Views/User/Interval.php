...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Home/</span> Interval</h4>
    <!-- Striped Rows -->
    <div class="col-xl">
        <div class="card">
            <h5 class="card-header">Langkah Ketiga Interval</h5>
            <h7 class="card-header">Interval = Batas Probabilitas Kumulatif</h7>
            <div class="card-body">
